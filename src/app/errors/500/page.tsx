...
export default function Page500() {
  ...
  // Goback
  const goback: any = () =>
    router?.back ? router.back() : router.replace('/');
    ...
    <div className="flex flex-col h-screen justify-center items-center gap-6">
      ...
      <div className="flex flex-col justify-center items-center gap-5">
        ...
        <p className="text-gray-500">
          Xin lỗi vì sự bất tiện vì đã có lỗi xảy ra ở phía server, vui lòng thử lại sau.
        </p>
        <div className="flex gap-5">
          ...
          <Button>
            <Link href="/admin/dashboard">Về trang chủ</Link>
          </Button>
        </div>
      </div>
    </div>
