...
export default function Dashboard() {
  ...
  // Return
  return (
    <div className="flex flex-1 flex-col items-start sm:gap-4">
      <h3 className="lg:text-3xl max-xl:text-center text-2xl uppercase font-bold flex flex-col items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
        Hệ thống quản lý hồ sơ sinh viên Đại học Công nghệ Đông Á
      </h3>
      <main className="grid flex-1 w-full items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
              ...
              {!isLoading && spacStatis ? (
                <div className="grid gap-3">
                  ...
                  <ul className="grid gap-3">
                    ...
                    <li className="flex items-center justify-between">
                      <span className="text-muted-foreground">
                        Sinh đã được duyệt hồ sơ
                      </span>
                      <span>{spacStatis?.approve_true} sinh viên </span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span className="text-muted-foreground">
                        Sinh chưa được duyệt hồ sơ
                      </span>
                      <span>{spacStatis?.approve_false} sinh viên </span>
                    </li>
                  </ul>
                  ...
                  <ul className="grid gap-3">
                    ...
                    <li className="flex items-center justify-between">
                      <span className="text-muted-foreground">
                        Sinh viên chưa đi học
                      </span>
                      <span>{spacStatis?.notyet} sinh viên </span>
                    </li>
                  </ul>
                </div>
              ) : (
